...
function ginkgo_theme() {
  ...
  $items['user_register'] = array(
    ...
    ),$items['user_login_block'] => array('template' => 'user_login_block','arguments' => array('form' => NULL)),
  );
  return $items;
}
...
function ginkgo_preprocess_user_login_block(&$variables) {
...
function ginko_menu_item($link, $has_children, $menu = '', $in_active_trail = FALSE, $extra_class = NULL) {
